...
## Bundle Import Request Hub

Request Hub เป็นหน้าแรกของเว็บสำหรับรับงาน `Web Shop` และ `Item Code` เก็บสถานะและไฟล์ประกอบ แล้วเปิดงานเข้า Import Studio ได้โดยตรง

ตั้งค่า Discord Webhook โดยสร้างไฟล์ `.env` ข้าง README แล้วใส่:

```text
PACK_QA_DISCORD_WEBHOOK_URL=https://discord.com/api/webhooks/...
```

Webhook URL จะอยู่ในเครื่องและไม่ถูกส่งกลับไปยัง browser ระบบจะแจ้งเมื่อสร้าง Request หรือเปลี่ยนสถานะ
